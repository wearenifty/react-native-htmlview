...
function htmlToElement(rawHtml, opts, done) {
  function domToElement(dom, parent) {
    ...
    return dom.map((node, index, list) => {
      ...
      if (node.type == 'text') {
        return (
          <Text key={index} style={parent ? opts.styles[parent.name] : null} allowFontScaling={opts.allowFontScaling}>
      ...
      if (node.type == 'tag') {
        ...
        return (
          <Text key={index} onPress={linkPressHandler} allowFontScaling={opts.allowFontScaling}>
